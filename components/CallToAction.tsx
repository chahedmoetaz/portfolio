    ...
    <SectionWrapper id='cta' className='xl:max-w-6xl my-24 lg:mx-10 xl:mx-auto mx-4 relative overflow-hidden flex flex-col-reverse md:flex-row gap-3 md:gap-0 items-center bg-gradient-to-r from-violet-700 to-purple-700 text-white rounded-2xl p-6 md:p-8 lg:px-12 lg:py-16 z-10'>
      <div className='flex flex-col md:w-1/2 lg:w-3/5'>
        ...
        <div className='flex items-center gap-4 my-4'>
          <Link href='https://github.com/chahedmoetaz' target='_blank' className='py-2 px-4 bg-white text-black rounded-lg w-fit flex items-center gap-2 hover:shadow-xl transition-shadow' rel='noreferrer'>
            <FaGithub />
            Fork Now
          </Link>
          <Link href='https://github.com/chahedmoetaz' target='_blank' className='py-2 px-4 bg-violet-800 rounded-lg w-fit flex items-center gap-2 hover:bg-violet-900 transition-all' rel='noreferrer'>
            Visit Docs
            <BiLinkExternal />
          </Link>
        </div>
